...
# Load the dataset
file_path = '/Users/mdanylchuk/Desktop/EE102 Final Proj/Data and Scripts/Global Competitiveness Index/Clean Data/Cleaned_GlobalCompetitiveness_data.csv'
data = pd.read_csv(file_path)

# Extract the numerical column
column = data['GlobalCompetitivenessIndex']
...
output_file = 'GlobalCompetitiveness_Analyzed.txt'
